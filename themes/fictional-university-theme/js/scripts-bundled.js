...
function () {
  ...
  _createClass(MyNotes, [{
    ...
    value: function editNote(e) {
      var thisNote = (0, _jquery.default)(e.target).parents('li'); // check if note is currently editable and call relevant function
    ...
    value: function makeNoteEditable(thisNote) {
      ...
      thisNote.find('.edit-note').html("<i class='fa fa-times' aria-hidden='true'></i>Cancel"); // make fields editable and add styling

      thisNote.find('.note-title-field, .note-body-field').removeAttr('readonly').addClass('note-active-field');
      thisNote.find('.update-note').addClass('update-note--visible'); // setting data state 
    ...
    value: function makeNoteReadOnly(thisNote) {
      // change edit to cancel
      thisNote.find('.edit-note').html("<i class='fa fa-pencil' aria-hidden='true'></i>Edit"); // make fields editable and add styling

      thisNote.find('.note-title-field, .note-body-field').attr('readonly', 'readonly').removeClass('note-active-field');
      thisNote.find('.update-note').removeClass('update-note--visible'); // setting data state
